...
class Renderer {
    ...
    render() {
        ...
        //texture
        numComponents = 2;
        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.mesh.buffers.textureCoord);
        this.gl.vertexAttribPointer(
            this.shaderProgram.programInfo.attribLocations.textureCoord,
            numComponents,
            type,
            normalize,
            stride,
        ...
        //normal
        numComponents = 3;
        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.mesh.buffers.normal);
        this.gl.vertexAttribPointer(
            this.shaderProgram.programInfo.attribLocations.vertexNormal,
            numComponents,
            type,
            normalize,
            stride,
        ...
        this.gl.enableVertexAttribArray(this.shaderProgram.programInfo.attribLocations.textureCoord);
        this.gl.enableVertexAttribArray(this.shaderProgram.programInfo.attribLocations.vertexNormal);
        ...
        this.gl.uniformMatrix4fv(
            this.shaderProgram.programInfo.uniformLocations.normalMatrix,
            false,
            this.normalMatrix);
